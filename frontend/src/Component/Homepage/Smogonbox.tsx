export default function Smogonbox() {
    return (
        <div className="text-white p-2">
            ...
            You can also get sample teams and ideas to 
            enhance your creativity ;)
            <br/><br/>
            <a 
                href = "https://www.smogon.com/"
                target = "_blank"
                className = "bg-blue-500 border-indigo-950 border-2 rounded-sm p-3 hover:text-pink-300 hover:bg-blue-950 hover:text-lg"            
            >
                SMOGON OFFICIAL WEBSITE
            </a>
        </div>
    )
}